...
void help()
{
    ...
    std::cout << "\tROT13 - Un crypteur/decrypteur de chaîne et fichier." << std::endl;
    std::cout << "SYNOPSIS" << std::endl;
    std::cout << "\tROT13 -c \"[CHAINE]\" | -f [FICHIER] | -h" << std::endl;
    std::cout << "DESCRIPTION" << std::endl;
    std::cout << "\tROT13 est un programme réalisé en C++ permettant de crypter et decrypter une chaîne ou un fichier en utilisant le célèbre algorithme de César en rotation par 13." << std::endl;
